...
<template>
	<header>
		<!-- <div id="menuBar" class="flex flex-row justify-between
	bg-gray-300"> -->
		<div id="fileUpDwn" class="inline-flex rounded-md shadow-sm" role="group">
			<button type="button" @click="newDatabase" class="">
			...
			<button type="button" @click="FileSystemAccessHelper.saveAsNew" :disabled="content == undefined" class="">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
					<path fill-rule="evenodd"
		...
		<div id="dbManipulation" class="inline-flex rounded-md shadow-sm" role="group">
			<button type="button" @click="executeUserQuery" :disabled="content == undefined" class="">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
					<path fill-rule="evenodd"
		...
		<div id="fileSaveLocal" class="inline-flex rounded-md shadow-sm" role="group">
			<button type="button" @click="FileSystemAccessHelper.updateLocal" :disabled="content == undefined" class="">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
					<path
...
button {
	@apply inline-flex items-center py-2 px-4 text-sm font-medium text-gray-900 bg-transparent rounded-r-md rounded-l-lg border border-gray-900;
